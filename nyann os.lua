...
local Window = Fluent:CreateWindow({Title = "TTD hub",SubTitle = "https://discord.gg/3zuHDZCybR",TabWidth = 155,Size = UDim2.fromOffset(650, 400),Acrylic = false,Theme = "Light",MinimizeKey = Enum.KeyCode.End})
...
ToggleButton.Position = UDim2.new(0, 10, 1, -65) -- góc dưới bên trái
ToggleButton.BackgroundColor3 = Color3.fromRGB(30,30,30)
ToggleButton.BackgroundTransparency = 0
ToggleButton.BorderSizePixel = 0
ToggleButton.Image = "rbxassetid://94678517792779"
...
local Tabs = {
  ...
  Combat = Window:AddTab({Title = "Player", Icon = "user"}),
  Settings = Window:AddTab({Title = "Setting", Icon = "rbxassetid://7734053495"}),
  Main = Window:AddTab({Title = "Home", Icon = "home"}),
  Melee = Window:AddTab({Title = "Fighting style", Icon = "rbxassetid://11162889532"}),
  Quests = Window:AddTab({Title = "Item", Icon = "rbxassetid://13075622619"}),
  SeaEvent = Window:AddTab({Title = "Sea", Icon = "rbxassetid://10709783577"}),
  Mirage = Window:AddTab({Title = "Race/V4", Icon = "rbxassetid://11162889532"}),
  Drago = Window:AddTab({Title = "Dragon Dojo", Icon = "layers"}),
  ...
  Misc = Window:AddTab({Title = "Miscellaneous", Icon = "rbxassetid://6031280882"})
}

-- Thêm vào tab Information
local DiscordSection = Tabs.Info:AddSection("Discord")

Tabs.Info:AddButton({
    Title = "Discord",
    Description = "https://discord.gg/3zuHDZCybR",
    Callback = function()
...
Tabs.Info:AddParagraph({
    Title = "nyan get script",
    Content = "https://discord.gg/3zuHDZCybR"
})

Tabs.Info:AddButton({
    Title = "Wed nyann get script hub",
    Description = "https://nyannos.github.io/get-script./",
    Callback = function()
        setclipboard("https://nyannos.github.io/get-script./")
        Fluent:Notify({
            Title = "Copied!",
            Content = "Đã sao chép link Wed!",
            Duration = 2
        })
    end
})
...
Tabs.Info:AddParagraph({
    Title = "nyan get script",
    Content = "https://nyannos.github.io/get-script./"
})

-- Thêm thông tin
Tabs.Info:AddParagraph({
    Title = "Script by TTD and nyann (Hai thg là một)",
    Content = "make by TTD and nyann"
})
...
-- TÙY CHỈNH
local TEXT = "nyann os"          -- Nội dung hiển thị
local TEXT_SIZE = 14             -- Kích thước chữ
